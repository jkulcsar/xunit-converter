...
namespace XUnitConverter.Tests
{
    public abstract class ConverterTestBase
    {
        ...
        private static readonly MetadataReference s_XunitCoreReference = MetadataReference.CreateFromFile(typeof(FactAttribute).Assembly.Location);
        private static readonly MetadataReference s_XunitAssertReference = MetadataReference.CreateFromFile(typeof(Assert).Assembly.Location);
